...
| `logo.png` | ~120px tall, width whatever keeps it proportional (roughly 300–500px wide) | PNG, transparent background | Header wordmark/emblem, shown at 48px tall — source larger (2–3x) so it stays sharp. Needs to read clearly on a navy-blue background, so light/white or full-color-with-white-outline versions work better than all-dark artwork. |
